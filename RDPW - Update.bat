...
REM
REM Info:
REM   The autoupdater will download the latest rdpwrap.ini from GITHUB/mreece/RDP-INI...
REM
REM { Special thanks to binarymaster, saurav-biswas, asmtron, sebaxakerhtc, stascorp and all other contributors as they did far more for this tool than I could ever dream. }

REM -----------------------------------------
REM Location of new/updated rdpwrap.ini files
REM -----------------------------------------
set rdpwrap_ini_update_github_1="https://raw.githubusercontent.com/mdreece/RDP-INI/main/RDPINI/rdpwrap.ini"
REM set rdpwrap_ini_update_github_2="https://raw.githubusercontent.com/....Extra.2...."
